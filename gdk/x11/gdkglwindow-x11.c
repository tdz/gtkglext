...
static GdkGLContext *_gdk_x11_gl_window_impl_create_gl_context  (GdkGLDrawable *gldrawable,
...
static GdkGLContext *
_gdk_x11_gl_window_impl_create_gl_context (GdkGLDrawable *gldrawable,
                                           GdkGLContext  *share_list,
                                           gboolean       direct,
                                           int            render_type)
{
